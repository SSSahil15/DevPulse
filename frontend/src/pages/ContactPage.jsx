...
const ContactPage = () => {
  ...
  const contactMethods = [
    { icon: <Mail className="w-6 h-6" />, title: "Email Address", desc: "ansarisahil3690@gmail.com", link: "mailto:ansarisahil3690@gmail.com", color: "from-blue-500/20 to-blue-600/20", iconColor: "text-blue-400" },
    { icon: <GithubIcon className="w-6 h-6" />, title: "GitHub Profile", desc: "github.com/SSSahil15", link: "https://github.com/SSSahil15", color: "from-slate-500/20 to-slate-600/20", iconColor: "text-slate-300" },
    { icon: <DiscordIcon className="w-6 h-6" />, title: "Discord Support", desc: "Join our Server", link: "https://discord.gg/gGaqBAVrGq", color: "from-indigo-500/20 to-indigo-600/20", iconColor: "text-indigo-400" }
  ];

  const supportCategories = [
    { icon: <Cpu className="w-5 h-5" />, title: "Technical Support", desc: "API issues, integration help" },
    { icon: <ShieldAlert className="w-5 h-5" />, title: "Security Reports", desc: "Vulnerability disclosures" },
    { icon: <Briefcase className="w-5 h-5" />, title: "Enterprise", desc: "Custom SLA, dedicated support" },
    { icon: <Users className="w-5 h-5" />, title: "Partnerships", desc: "Business inquiries" }
  ];

  const faqs = [
    { q: "What is your typical response time?", a: "We aim to respond to all standard inquiries within 24 hours. Enterprise customers receive priority support with a 4-hour SLA." },
    { q: "Do you offer phone support?", a: "Phone support is currently reserved for our Enterprise plan members. All other users can reach us via email or Discord." },
    { q: "Where can I find API documentation?", a: "Our comprehensive API documentation is available in the Docs section, complete with code examples and interactive endpoints." }
  ];
    ...
    <StaticPageLayout>
      ...
      <div className="max-w-7xl mx-auto px-6 py-24 relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          >
            Whether you have a technical question, want to explore enterprise options, or just want to say hi, our team is ready to assist you.
          </motion.p>
        </div>
            ...
            >
              ...
              <div className="relative z-10 flex flex-col items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400 group-hover:text-slate-300 transition-colors">{method.desc}</p>
                </div>
              </div>
            </motion.a>
          ))}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-start">
                  ...
                  <div className="relative">
                    ...
                    >
                      {supportCategories.map((cat, idx) => (
                        <option key={idx} value={cat.title} className="bg-slate-800 text-white">{cat.title}</option>
                      ))}
                    </select>
          ...
          >
            ...
            <div className="p-6 rounded-3xl bg-indigo-900/10 border border-indigo-500/20 backdrop-blur-md">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400 mb-3">Our global support team is active 24/7 across multiple timezones.</p>
            ...
            <div className="p-6 rounded-3xl bg-slate-800/30 border border-slate-700/50 backdrop-blur-md">
              ...
              <a href="/docs" className="inline-flex items-center gap-1 text-sm text-indigo-400 hover:text-indigo-300 mt-5 transition-colors">
