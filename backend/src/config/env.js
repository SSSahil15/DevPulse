...
const envSchema = z.object({
  ...
  // Remediation engine feature flag
  GITHUB_REMEDIATION_ENABLED: z.coerce.boolean().default(true),
  REMEDIATION_MAX_VULNS_PER_JOB: z.coerce.number().int().positive().max(100).default(25),
});
...
module.exports = {
  ...
  allowedOrigins: (env.ALLOWED_ORIGINS || '')
    ...
    .map((o) => o.trim())
    .filter(Boolean),
  remediationEnabled: env.GITHUB_REMEDIATION_ENABLED,
  remediationMaxVulns: env.REMEDIATION_MAX_VULNS_PER_JOB,
};
